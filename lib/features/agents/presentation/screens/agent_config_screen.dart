      ...
      body: Column(
        ...
        children: [
          TextFormField(
            ...
            onChanged: ref.read(agentControllerProvider.notifier).setName,
            decoration: const InputDecoration(labelText: 'Nom de l’agent'),
          ),
          const SizedBox(height: 14),
          DropdownButtonFormField<AgentAutonomy>(
            initialValue: agent.autonomy,
            decoration: const InputDecoration(labelText: 'Niveau d’autonomie'),
            items: const [
              DropdownMenuItem(
                value: AgentAutonomy.approvalRequired,
                child: Text('Approbation obligatoire'),
              ),
              DropdownMenuItem(
                value: AgentAutonomy.supervised,
                child: Text('Supervisé'),
              ),
              DropdownMenuItem(
                value: AgentAutonomy.autonomous,
                child: Text('Autonome'),
              ),
            ],
            onChanged:
          ...
          FilledButton(
            onPressed:
                () => Navigator.pushNamed(context, AppRoutes.agentPermissions),
