    ...
    return FeatureScaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(
                colors: [Color(0xFF7C2D12), Color(0xFFFB923C)],
              ),
            ),
            child: const Center(
              child: Icon(
          ...
          FilledButton(
            onPressed: () {
              ref.read(videoJobControllerProvider.notifier).setUrl(_url.text);
              Navigator.pushNamed(context, AppRoutes.videoConfig);
            },
            child: const Text('Analyser la vidéo'),
          ),
        ],
      ),
    );
