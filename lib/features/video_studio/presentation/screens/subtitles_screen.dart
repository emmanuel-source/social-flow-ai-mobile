    ...
    return FeatureScaffold(
      ...
      body: Column(
        ...
        children: [
          SegmentedButton<int>(
            segments: const [
              ButtonSegment(value: 0, label: Text('Minimal')),
              ButtonSegment(value: 1, label: Text('Dynamique')),
              ButtonSegment(value: 2, label: Text('Karaoké')),
            ],
            selected: {_style},
          ...
          FilledButton(
            ...
            child: const Text('Utiliser ce clip'),
          ),
        ],
      ),
    );
